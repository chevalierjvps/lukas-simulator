...
// missing, and migration 0057 rewrites installed copies that still carry the
...
const MIGRATION = path.join(__dirname, '..', '..', 'migrations', '0057_patient_template_short_answers.sql');
...
describe('migration 0057 on an upgraded install', () => {

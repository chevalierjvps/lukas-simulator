...
export default function ManikinPanel({
    ...
    const performExam = usePhysicalExam({ physicalExam: physicalExam || SAMPLE_ABNORMAL_EXAM, sessionId, caseLanguage });
    // State
    ...
    const handleExamTypeSelect = useCallback((examType, specialTestName = null) => {
        ...
        // shared hook (caseLanguage-aware defaults, per-focus synth
        // `points`), so this room and the 3D room cannot drift apart.

...
describe('OrdersDrawer — guard render', () => {
    ...
    it('docks the floating pills at the seam by default and at the very left for fabAlign="left"', async () => {
        ...
        // 250px, not the upstream 88px: this fork's strip also has to clear
        // TacticalClinicalHud's action wheel, which docks above the
        // RoomNavigator too (see the comment on the strip's own style block).
        expect(strip().style.bottom).toBe('250px');
    });
});

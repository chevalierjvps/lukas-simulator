...
async function seedDefaultAgents() {
    ...
    const configPatches = [
        ...
        { type: 'patient', name: 'Default Patient', voice: { gender: 'male', case_voice: 'pt-BR-Chirp3-HD-Charon', tts_provider: 'google' }, dos: PATIENT_TEMPLATE_DOS, donts: PATIENT_TEMPLATE_DONTS },
        { type: 'patient', name: 'Default Female Patient', voice: { gender: 'female', case_voice: 'pt-BR-Chirp3-HD-Aoede', tts_provider: 'google' }, dos: PATIENT_TEMPLATE_DOS, donts: PATIENT_TEMPLATE_DONTS },
    ];
